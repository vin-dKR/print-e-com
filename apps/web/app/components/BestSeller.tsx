...
export default function BestSeller() {
    ...
    // Loading skeleton - matching PopularProducts
    if (loading) {
        return (
    ...
    return (
        <section className="py-12 bg-white">
            <div className="w-full px-10">
                ...
                {/* Horizontal Scrollable Product Grid - matching PopularProducts */}
                <div className="overflow-x-auto scrollbar-hide">
                    <div className="flex gap-6 pb-4" style={{ minWidth: "max-content" }}>
                        {products.map((product) => (
                            ...
                            >
                                {/* Product Image - matching PopularProducts */}
                                <Link href={`/products/${product.id}`} className="block relative aspect-square bg-gray-100">
                                    ...
                                    {/* Bestseller Badge - positioned like PopularProducts */}
                                    <div className="absolute top-3 left-3 bg-orange-500 text-white text-xs font-bold px-3 py-1.5 rounded-xl shadow-md">
                                        BESTSELLER
                                    </div>
                                </Link>
                                {/*
                                ...
                                {/* Product Info - matching PopularProducts */}
                                <div className="p-4">
                                ...
                                {/* Add to Cart Button - matching PopularProducts */}
                                <button
