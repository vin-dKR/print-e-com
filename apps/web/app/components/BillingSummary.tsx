    ...
    return (
        <div className="bg-white rounded-2xl border border-gray-100 shadow-md p-6">
            ...
            <div className="space-y-3 mb-6">
                ...
                {warranty && warranty > 0 && (
                    <div className="flex justify-between text-gray-600">
                        ...
                        <span className="font-hkgb font-medium">₹{warranty.toFixed(2)}</span>
                    </div>
                )}
            ...
            <button
                ...
                className={`w-full font-hkgb font-bold px-6 py-4 rounded-lg font-medium text-white transition-colors ${agreedToTerms
